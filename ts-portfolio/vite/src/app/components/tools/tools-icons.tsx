...
//                 >
//                     <img
//                         css={(layout.width80, style.techIconBasics)}
//                         src={basics}
...
//                 >
//                     <div css={imgCont}>
//                         <img css={smallIcon} src={react} alt="react.js" />
//                         <img css={smallIcon} src={node} alt="nodeJS" />
//                     </div>
//                     <div css={imgCont}>
//                         <img css={smallIcon} src={jquery} alt="jquery" />
//                         <img
//                             css={smallIcon}
//                             src={postgresql}
//                             alt="postgreSQL"
...
//                     ]}
//                 >
//                     <img css={style.img} src={python} alt="python" />
//                     <img css={style.img} src={sql} alt="SQL" />
//                 </div>
//             </div>
//         </>
//     )
